...
function makeOverviewData(attempts: OverviewAttemptView[], selectedAttemptId: number | null = null): RunTrainingItemOverview {
  return {
    runTrainingItem: {
      ...
      qualifyingAttemptId: null, trainingId: null, scheduleName: null, scheduleId: null, subsetId: null,
    },
    trainingItem: { fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1', solution: ['e2e4'], prelude: [], source: { sourceType: 'SCRAPED_POSITIONAL', internalId: 1, lichessUrl: 'https://lichess.org/training/1', difficulty: { value: 1, label: 'Easy', minRating: null, maxRating: null }, themes: [], opening: null } },
    selectedAttemptId,
    pgn: null,
    attempts,
