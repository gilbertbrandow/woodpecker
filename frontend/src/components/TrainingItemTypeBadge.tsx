...
const BADGE_CONFIG: Record<TrainingItemSource, BadgeConfig> = {
  LICHESS_TACTIC: {
    label: 'Tactic',
...
export function TrainingItemTypeBadge({ sourceType, className }: TrainingItemTypeBadgeProps): React.ReactElement {
